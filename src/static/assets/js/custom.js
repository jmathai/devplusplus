...
! function($) {
    ...
    Sofash.prototype.initStickyAddMenu = function() {
        ...
        if (stickyElement.length === 0) return; // Exit if element doesn't exist
        
        $(window).on('scroll', function() {
            var scroll = $(window).scrollTop();

            if (scroll >= 50) {
                stickyElement.addClass("stickyadd");
            } else {
                stickyElement.removeClass("stickyadd");
            }
        });
    },
    ...
    Sofash.prototype.initFunFacts = function() {
        ...
        if (counterElement.length === 0) return; // Exit if element doesn't exist
